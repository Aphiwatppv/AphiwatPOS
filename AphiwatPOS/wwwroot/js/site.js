(() => {
  ...
  // rubberPay.cleanOverride.v2

  Object.assign(translations.en, {
    'rubberPay.all': 'All',
    'rubberPay.amountPaid': 'Amount paid',
    'rubberPay.baht': 'baht',
    'rubberPay.bahtPerKg': 'baht/kg',
    'rubberPay.clearFilters': 'Clear filters',
    'rubberPay.creditHelp': 'If selected, the system records the full rubber bill payment and also pays outstanding credit of',
    'rubberPay.creditQuestion': 'Customer has outstanding credit. Pay it now?',
    'rubberPay.customerCreditDue': 'Customer has outstanding credit',
    'rubberPay.dateFrom': 'Date from',
    'rubberPay.dateTo': 'Date to',
    'rubberPay.historyPlaceholder': 'Receipt no, seller, phone, or location',
    'rubberPay.kg': 'kg',
    'rubberPay.netAmount': 'Net amount',
    'rubberPay.noPaymentHistory': 'No payment history yet.',
    'rubberPay.notNow': 'Not now',
    'rubberPay.paidAmount': 'Paid amount',
    'rubberPay.paidDate': 'Paid date',
    'rubberPay.payAmount': 'Pay amount',
    'rubberPay.payCreditWithBill': 'Pay outstanding credit',
    'rubberPay.paymentHistoryHelp': 'Review paid rubber bills and reprint receipts.',
    'rubberPay.print': 'Print',
    'rubberPay.printReceipt': 'Print receipt',
    'rubberPay.receiptNo': 'Receipt no',
    'rubberPay.records': 'records',
    'rubberPay.remarkPlaceholder': 'Reference number or additional note',
    'rubberPay.reviewAgain': 'Review again',
    'rubberPay.rubberSeller': 'Rubber seller',
    'rubberPay.searchHistory': 'Search history',
    'rubberPay.searchSeller': 'Search seller',
    'rubberPay.viewPrint': 'View/print'
  });
  ...
  Object.assign(translations.th, {
    ...
    'rubberDisplay.subtitle': '\u0e01\u0e23\u0e38\u0e13\u0e32\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e1a\u0e34\u0e25\u0e01\u0e31\u0e1a\u0e41\u0e04\u0e0a\u0e40\u0e0a\u0e35\u0e22\u0e23\u0e4c',
    'rubberDisplay.weight': '\u0e19\u0e49\u0e33\u0e2b\u0e19\u0e31\u0e01',
    'rubberPay.all': '\u0e17\u0e31\u0e49\u0e07\u0e2b\u0e21\u0e14',
    'rubberPay.amountPaid': '\u0e22\u0e2d\u0e14\u0e0a\u0e33\u0e23\u0e30',
    'rubberPay.baht': '\u0e1a\u0e32\u0e17',
    'rubberPay.bahtPerKg': '\u0e1a\u0e32\u0e17/\u0e01\u0e01.',
    'rubberPay.billDate': '\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48\u0e23\u0e31\u0e1a\u0e0b\u0e37\u0e49\u0e2d',
    'rubberPay.billList': '\u0e1a\u0e34\u0e25\u0e17\u0e35\u0e48\u0e23\u0e2d\u0e0a\u0e33\u0e23\u0e30',
    'rubberPay.billListHelp': '\u0e04\u0e49\u0e19\u0e2b\u0e32\u0e08\u0e32\u0e01\u0e23\u0e2b\u0e31\u0e2a\u0e2a\u0e21\u0e32\u0e0a\u0e34\u0e01 \u0e0a\u0e37\u0e48\u0e2d\u0e1c\u0e39\u0e49\u0e02\u0e32\u0e22 \u0e2b\u0e23\u0e37\u0e2d\u0e40\u0e1a\u0e2d\u0e23\u0e4c\u0e42\u0e17\u0e23',
    'rubberPay.cash': '\u0e40\u0e07\u0e34\u0e19\u0e2a\u0e14',
    'rubberPay.cashHelp': '\u0e23\u0e31\u0e1a\u0e40\u0e07\u0e34\u0e19\u0e2a\u0e14\u0e41\u0e25\u0e30\u0e2d\u0e2d\u0e01\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08\u0e17\u0e31\u0e19\u0e17\u0e35',
    'rubberPay.clearFilters': '\u0e25\u0e49\u0e32\u0e07\u0e15\u0e31\u0e27\u0e01\u0e23\u0e2d\u0e07',
    'rubberPay.confirm': '\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e01\u0e32\u0e23\u0e08\u0e48\u0e32\u0e22\u0e1a\u0e34\u0e25',
    'rubberPay.creditHelp': '\u0e2b\u0e32\u0e01\u0e40\u0e25\u0e37\u0e2d\u0e01 \u0e23\u0e30\u0e1a\u0e1a\u0e08\u0e30\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e0a\u0e33\u0e23\u0e30\u0e1a\u0e34\u0e25\u0e22\u0e32\u0e07\u0e40\u0e15\u0e47\u0e21\u0e08\u0e33\u0e19\u0e27\u0e19 \u0e41\u0e25\u0e30\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e04\u0e23\u0e14\u0e34\u0e15\u0e04\u0e49\u0e32\u0e07\u0e2d\u0e35\u0e01',
    'rubberPay.creditQuestion': '\u0e25\u0e39\u0e01\u0e04\u0e49\u0e32\u0e21\u0e35\u0e40\u0e04\u0e23\u0e14\u0e34\u0e15\u0e04\u0e49\u0e32\u0e07\u0e0a\u0e33\u0e23\u0e30 \u0e15\u0e49\u0e2d\u0e07\u0e01\u0e32\u0e23\u0e0a\u0e33\u0e23\u0e30\u0e14\u0e49\u0e27\u0e22\u0e44\u0e2b\u0e21?',
    'rubberPay.customerCreditDue': '\u0e25\u0e39\u0e01\u0e04\u0e49\u0e32\u0e21\u0e35\u0e40\u0e04\u0e23\u0e14\u0e34\u0e15\u0e04\u0e49\u0e32\u0e07\u0e0a\u0e33\u0e23\u0e30',
    'rubberPay.customerDisplay': '\u0e08\u0e2d\u0e25\u0e39\u0e01\u0e04\u0e49\u0e32',
    'rubberPay.dateFrom': '\u0e08\u0e32\u0e01\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48',
    'rubberPay.dateTo': '\u0e16\u0e36\u0e07\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48',
    'rubberPay.deduction': '\u0e2b\u0e31\u0e01',
    'rubberPay.dueBills': '\u0e1a\u0e34\u0e25\u0e23\u0e2d\u0e08\u0e48\u0e32\u0e22',
    'rubberPay.fullAmount': '\u0e22\u0e2d\u0e14\u0e17\u0e35\u0e48\u0e15\u0e49\u0e2d\u0e07\u0e08\u0e48\u0e32\u0e22\u0e40\u0e15\u0e47\u0e21\u0e08\u0e33\u0e19\u0e27\u0e19',
    'rubberPay.fullPaymentOnly': '\u0e23\u0e30\u0e1a\u0e1a\u0e19\u0e35\u0e49\u0e08\u0e48\u0e32\u0e22\u0e40\u0e15\u0e47\u0e21\u0e08\u0e33\u0e19\u0e27\u0e19\u0e40\u0e17\u0e48\u0e32\u0e19\u0e31\u0e49\u0e19',
    'rubberPay.historyPlaceholder': '\u0e40\u0e25\u0e02\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08 \u0e1c\u0e39\u0e49\u0e02\u0e32\u0e22 \u0e40\u0e1a\u0e2d\u0e23\u0e4c\u0e42\u0e17\u0e23 \u0e2b\u0e23\u0e37\u0e2d\u0e2a\u0e16\u0e32\u0e19\u0e17\u0e35\u0e48',
    'rubberPay.kg': '\u0e01\u0e01.',
    'rubberPay.latestReceipt': '\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08\u0e25\u0e48\u0e32\u0e2a\u0e38\u0e14',
    'rubberPay.location': '\u0e2a\u0e16\u0e32\u0e19\u0e17\u0e35\u0e48\u0e23\u0e31\u0e1a\u0e0b\u0e37\u0e49\u0e2d',
    'rubberPay.netAmount': '\u0e22\u0e2d\u0e14\u0e2a\u0e38\u0e17\u0e18\u0e34',
    'rubberPay.noBillSelected': '\u0e40\u0e25\u0e37\u0e2d\u0e01\u0e1a\u0e34\u0e25\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.noDueBills': '\u0e44\u0e21\u0e48\u0e21\u0e35\u0e1a\u0e34\u0e25\u0e04\u0e49\u0e32\u0e07\u0e0a\u0e33\u0e23\u0e30',
    'rubberPay.noPaymentHistory': '\u0e22\u0e31\u0e07\u0e44\u0e21\u0e48\u0e21\u0e35\u0e1b\u0e23\u0e30\u0e27\u0e31\u0e15\u0e34\u0e01\u0e32\u0e23\u0e08\u0e48\u0e32\u0e22\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.notNow': '\u0e22\u0e31\u0e07\u0e44\u0e21\u0e48\u0e1e\u0e34\u0e21\u0e1e\u0e4c',
    'rubberPay.outstandingTotal': '\u0e22\u0e2d\u0e14\u0e04\u0e49\u0e32\u0e07\u0e23\u0e27\u0e21',
    'rubberPay.paidAmount': '\u0e0a\u0e33\u0e23\u0e30\u0e41\u0e25\u0e49\u0e27',
    'rubberPay.paidDate': '\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48\u0e08\u0e48\u0e32\u0e22',
    'rubberPay.payAmount': '\u0e22\u0e2d\u0e14\u0e08\u0e48\u0e32\u0e22',
    'rubberPay.payCreditWithBill': '\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e04\u0e23\u0e14\u0e34\u0e15\u0e04\u0e49\u0e32\u0e07\u0e14\u0e49\u0e27\u0e22',
    'rubberPay.payFull': '\u0e08\u0e48\u0e32\u0e22\u0e1a\u0e34\u0e25\u0e40\u0e15\u0e47\u0e21\u0e08\u0e33\u0e19\u0e27\u0e19',
    'rubberPay.payment': '\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.paymentHelp': '\u0e15\u0e23\u0e27\u0e08\u0e2a\u0e2d\u0e1a\u0e22\u0e2d\u0e14\u0e01\u0e48\u0e2d\u0e19\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e41\u0e25\u0e30\u0e1e\u0e34\u0e21\u0e1e\u0e4c\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08',
    'rubberPay.paymentHistory': '\u0e1b\u0e23\u0e30\u0e27\u0e31\u0e15\u0e34\u0e01\u0e32\u0e23\u0e08\u0e48\u0e32\u0e22\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.paymentHistoryHelp': '\u0e14\u0e39\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23\u0e17\u0e35\u0e48\u0e40\u0e04\u0e22\u0e0a\u0e33\u0e23\u0e30\u0e41\u0e25\u0e49\u0e27 \u0e41\u0e25\u0e30\u0e1e\u0e34\u0e21\u0e1e\u0e4c\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08\u0e22\u0e49\u0e2d\u0e19\u0e2b\u0e25\u0e31\u0e07',
    'rubberPay.paymentMethod': '\u0e27\u0e34\u0e18\u0e35\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.price': '\u0e23\u0e32\u0e04\u0e32',
    'rubberPay.print': '\u0e1e\u0e34\u0e21\u0e1e\u0e4c',
    'rubberPay.printReceipt': '\u0e1e\u0e34\u0e21\u0e1e\u0e4c\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08',
    'rubberPay.receiptNo': '\u0e40\u0e25\u0e02\u0e17\u0e35\u0e48\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08',
    'rubberPay.receiptQuestion': '\u0e15\u0e49\u0e2d\u0e07\u0e01\u0e32\u0e23\u0e1e\u0e34\u0e21\u0e1e\u0e4c\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08\u0e44\u0e2b\u0e21?',
    'rubberPay.records': '\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23',
    'rubberPay.remark': '\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38',
    'rubberPay.remarkPlaceholder': '\u0e40\u0e25\u0e02\u0e2d\u0e49\u0e32\u0e07\u0e2d\u0e34\u0e07\u0e2b\u0e23\u0e37\u0e2d\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38\u0e40\u0e1e\u0e34\u0e48\u0e21\u0e40\u0e15\u0e34\u0e21',
    'rubberPay.reviewAgain': '\u0e15\u0e23\u0e27\u0e08\u0e2a\u0e2d\u0e1a\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07',
    'rubberPay.rubberSeller': '\u0e1c\u0e39\u0e49\u0e02\u0e32\u0e22\u0e22\u0e32\u0e07',
    'rubberPay.searchHistory': '\u0e04\u0e49\u0e19\u0e2b\u0e32\u0e1b\u0e23\u0e30\u0e27\u0e31\u0e15\u0e34',
    'rubberPay.searchSeller': '\u0e04\u0e49\u0e19\u0e2b\u0e32\u0e1c\u0e39\u0e49\u0e02\u0e32\u0e22',
    'rubberPay.seller': '\u0e1c\u0e39\u0e49\u0e02\u0e32\u0e22',
    'rubberPay.subtitle': '\u0e40\u0e25\u0e37\u0e2d\u0e01\u0e1a\u0e34\u0e25\u0e23\u0e31\u0e1a\u0e0b\u0e37\u0e49\u0e2d\u0e22\u0e32\u0e07 \u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e01\u0e32\u0e23\u0e0a\u0e33\u0e23\u0e30\u0e40\u0e07\u0e34\u0e19 \u0e41\u0e25\u0e30\u0e1e\u0e34\u0e21\u0e1e\u0e4c\u0e43\u0e1a\u0e40\u0e2a\u0e23\u0e47\u0e08\u0e23\u0e31\u0e1a\u0e40\u0e07\u0e34\u0e19',
    'rubberPay.title': '\u0e08\u0e48\u0e32\u0e22\u0e1a\u0e34\u0e25\u0e22\u0e32\u0e07\u0e1e\u0e32\u0e23\u0e32',
    'rubberPay.transfer': '\u0e42\u0e2d\u0e19\u0e1a\u0e31\u0e0d\u0e0a\u0e35',
    'rubberPay.transferHelp': '\u0e1a\u0e31\u0e19\u0e17\u0e36\u0e01\u0e40\u0e25\u0e02\u0e2d\u0e49\u0e32\u0e07\u0e2d\u0e34\u0e07\u0e43\u0e19\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38',
    'rubberPay.viewPrint': '\u0e14\u0e39/\u0e1e\u0e34\u0e21\u0e1e\u0e4c',
    'rubberPay.weight': '\u0e19\u0e49\u0e33\u0e2b\u0e19\u0e31\u0e01'
  });
