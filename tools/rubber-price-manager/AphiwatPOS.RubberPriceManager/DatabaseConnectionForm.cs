...
public sealed class DatabaseConnectionForm : Form
{
    ...
    public DatabaseConnectionForm(string sqlServer, string databaseName, bool trustServerCertificate)
    {
        Text = "Rubber Price Database";
    ...
    private Control BuildHeader()
    {
        ...
        var title = new Label
        {
            Text = "Connect Rubber Price Database",
            Dock = DockStyle.Top,
            Height = 34,
    ...
    private Control BuildFields()
    {
        ...
        RubberPriceManagerForm.AddLabel(panel, "SQL Server", 0, 0);
        panel.Controls.Add(_server, 1, 0);
        RubberPriceManagerForm.AddLabel(panel, "Database", 0, 1);
        panel.Controls.Add(_database, 1, 1);
        panel.Controls.Add(_trustCertificate, 1, 2);

        var note = new Label
        {
            Text = "On connect, the manager will create or repair the RubberPrice and RubberAuctionLocation SQL objects if your Windows login has permission.",
            Dock = DockStyle.Fill,
    ...
    private Control BuildActions()
    {
        ...
        var connect = new Button
        {
            ...
            Width = 126,
            Height = 40,
            Image = PriceManagerIcons.CreateDatabaseIcon(Color.White),
    ...
    private bool ValidateConnectionInputs()
    {
        ...
        {
            MessageBox.Show(this, "SQL Server is required.", "Rubber price database", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            _server.Focus();
            return false;
        }
        ...
        {
            MessageBox.Show(this, "Database name is required.", "Rubber price database", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            _database.Focus();
            return false;
        }
