CREATE PROCEDURE [dbo].[spCustomerReportGetSummary] @DateFrom DATETIME2=NULL,@DateTo DATETIME2=NULL,@MemberLevelId INT=NULL,@IsActive BIT=NULL,@Top INT=20,@NoPurchaseAfterDate DATETIME2=NULL AS
BEGIN
